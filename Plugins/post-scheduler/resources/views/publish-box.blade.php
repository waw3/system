<div class="row form-group @if ($errors->has('publish_date')) has-error @endif">
    ...
    <div class="col-sm-9">
        <div class="input-group date form_datetime form_datetime bs-datetime">
            {!! Form::text('publish_date', old('publish_date', $publishDate), ['class' => 'form-control datepicker', 'id' => 'publish_date', 'data-date-format' => mconfig('base.config.date_format.js.date'),]) !!}
...
@if ($data && $data->status != \Modules\Base\Enums\BaseStatusEnum::PUBLISHED)

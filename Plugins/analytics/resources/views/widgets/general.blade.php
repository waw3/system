...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.sessions') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.visitors') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box border-green-haze">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.pageviews') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.bounce_rate') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.percent_new_session') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.page_session') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.avg_duration') }}</span>
...
<div class="col-lg-3 col-md-4 col-sm-6">
    <div class="info-box">
        ...
        <div class="info-box-content">
            <span class="info-box-text">{{ trans('modules.plugins.analytics::analytics.new_users') }}</span>
...
<div data-lang-pageviews='{{ trans("modules.plugins.analytics::analytics.pageviews") }}'></div>
<div data-lang-visits='{{ trans("modules.plugins.analytics::analytics.visitors") }}'></div>

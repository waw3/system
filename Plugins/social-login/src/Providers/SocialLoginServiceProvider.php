...
use Modules\Plugins\SocialLogin\Facades\SocialServiceFacade;
...
class SocialLoginServiceProvider extends ServiceProvider
{
    ...
    {
        $this->setNamespace('modules.plugins.social-login')
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()->registerItem([
                ...
                'name'        => 'modules.plugins.social-login::social-login.menu',
                'icon'        => null,

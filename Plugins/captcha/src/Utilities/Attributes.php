...
namespace Modules\Plugins\Captcha\Utilities;

use Modules\Plugins\Captcha\Contracts\Utilities\AttributesContract;
use Modules\Plugins\Captcha\Exceptions\InvalidArgumentException;
...
class Attributes implements AttributesContract
{
     ...
     * @return array
     *
     * @throws \Modules\Plugins\Captcha\Exceptions\InvalidArgumentException
     */

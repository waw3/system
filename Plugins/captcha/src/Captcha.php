...
namespace Modules\Plugins\Captcha;

use Modules\Plugins\Captcha\Contracts\CaptchaContract;
use Modules\Plugins\Captcha\Contracts\Utilities\AttributesContract;
use Modules\Plugins\Captcha\Contracts\Utilities\RequestContract;
use Modules\Plugins\Captcha\Exceptions\ApiException;
use Modules\Plugins\Captcha\Utilities\Attributes;
use Modules\Plugins\Captcha\Utilities\Request;
...
class Captcha implements CaptchaContract
{
     ...
     * HTTP Request Client
     *
     * @var \Modules\Plugins\Captcha\Contracts\Utilities\RequestContract
     */
    protected $request;
     ...
     * Captcha Attributes
     *
     * @var \Modules\Plugins\Captcha\Contracts\Utilities\AttributesContract
     */

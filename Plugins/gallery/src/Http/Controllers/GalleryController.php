...
use Modules\Plugins\Gallery\Forms\GalleryForm;
use Modules\Plugins\Gallery\Tables\GalleryTable;
...
class GalleryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.gallery::gallery.galleries'));
    ...
    {
        page_title()->setTitle(trans('modules.plugins.gallery::gallery.create'));
    ...
    public function edit($id, Request $request, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('modules.plugins.gallery::gallery.edit') . ' "' . $gallery->name . '"');

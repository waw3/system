...
class UpdateGalleryMetaTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('gallery_meta')->where('reference_type', 'gallery')->update(['reference_type' => \Modules\Plugins\Gallery\Models\Gallery::class]);
    }
    ...
    public function down()
    {
        ...
        DB::table('gallery_meta')->where('reference', \Modules\Plugins\Gallery\Models\Gallery::class)->update(['reference' => 'gallery']);
    }
}

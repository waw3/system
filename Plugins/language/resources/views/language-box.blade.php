...
@if (count($languages) > 1)
    <div><strong>{{ trans('modules.plugins.language::language.translations') }}</strong>
    ...
    {!! Form::modalAction('confirm-change-language-modal', trans('modules.plugins.language::language.confirm-change-language'), 'warning', trans('modules.plugins.language::language.confirm-change-language-message'), 'confirm-change-language-button', trans('modules.plugins.language::language.confirm-change-language-btn')) !!}
@endif

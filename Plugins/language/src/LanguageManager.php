...
use Modules\Plugins\Language\Models\Language;
...
class LanguageManager
{
    ...
    {
        return setting('language_hide_default', config('modules.plugins.language.general.hideDefaultLocaleInURL'));
    }
    ...
    public function supportedModels()
    {
        return apply_filters(LANGUAGE_FILTER_MODEL_USING_MULTI_LANGUAGE,
            config('modules.plugins.language.general.supported', []));
    }
    ...
    public function registerModule($model)
    {
        ...
        config([
            'modules.plugins.language.general.supported' => array_merge(config('modules.plugins.language.general.supported', []), $model),
        ]);
    ...
    {
        return config('modules.plugins.language.general.useAcceptLanguageHeader');
    }
}

...
namespace Modules\Plugins\CustomField\Support;
...
class CustomFieldSupport
{
    ...
    {
        return view('modules.plugins.custom-field::_script-templates.rules', [
    ...
    {
        return view('modules.plugins.custom-field::custom-fields-boxes-renderer', [
    ...
    public function renderAssets()
    {
        if (!$this->isRenderedAssets) {
            echo view('modules.plugins.custom-field::_script-templates.render-custom-fields')->render();
    ...
    public function registerModule($module): self
    {
        ...
        $configKey = 'modules.plugins.custom-field.general.supported';
    ...
    {
        return config('modules.plugins.custom-field.general.supported', []);
    }
}

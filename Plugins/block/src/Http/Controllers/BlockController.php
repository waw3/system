...
namespace Modules\Plugins\Block\Http\Controllers;
...
use Modules\Plugins\Block\Forms\BlockForm;
use Modules\Plugins\Block\Http\Requests\BlockRequest;
use Modules\Plugins\Block\Repositories\Interfaces\BlockInterface;
use Illuminate\Http\Request;
use Exception;
use Modules\Plugins\Block\Tables\BlockTable;
...
class BlockController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.block::block.menu'));
    ...
    {
        page_title()->setTitle(trans('modules.plugins.block::block.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('modules.plugins.block::block.edit') . ' "' . $block->name . '"');

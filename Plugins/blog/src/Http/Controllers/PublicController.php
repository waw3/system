...
class PublicController extends Controller
{
    ...
    public function getTag($slug)
    {
        ...
        if (function_exists('admin_bar')) {
            admin_bar()->registerLink(trans('modules.plugins.blog::tags.edit_this_tag'), route('tags.edit', $tag->id));
        }
        ...
        return Theme::scope('tag', compact('tag', 'posts'), 'modules.plugins.blog::themes.tag')->render();
    }
}

...
use Modules\Plugins\Blog\Forms\TagForm;
use Modules\Plugins\Blog\Tables\TagTable;
use Modules\Plugins\Blog\Http\Requests\TagRequest;
...
class TagController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.blog::tags.menu'));
    ...
    {
        page_title()->setTitle(trans('modules.plugins.blog::tags.create'));
    ...
    public function edit($id, Request $request, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('modules.plugins.blog::tags.edit') . ' "' . $tag->name . '"');
    ...
    public function destroy($id, Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response->setMessage(trans('modules.plugins.blog::tags.deleted'));
        } catch (Exception $exception) {
            return $response
                ->setError()
                ->setMessage(trans('modules.plugins.blog::tags.cannot_delete'));
        }
    }

...
use Modules\Plugins\Blog\Forms\CategoryForm;
use Modules\Plugins\Blog\Tables\CategoryTable;
...
class CategoryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.blog::categories.menu'));
    ...
    {
        page_title()->setTitle(trans('modules.plugins.blog::categories.create'));
    ...
    public function edit(Request $request, $id, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('modules.plugins.blog::categories.edit') . ' "' . $category->name . '"');

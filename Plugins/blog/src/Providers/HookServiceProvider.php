...
class HookServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (function_exists('add_shortcode')) {
            ...
            shortcode()->setAdminConfig('blog-posts', view('modules.plugins.blog::partials.posts-short-code-admin-config')->render());
        }
    }
    ...
    public function registerMenuOptions()
    {
        if (Auth::user()->hasPermission('categories.index')) {
            ...
            echo view('modules.plugins.blog::categories.menu-options', compact('categories'));
        }
        ...
        if (Auth::user()->hasPermission('tags.index')) {
            ...
            echo view('modules.plugins.blog::tags.partials.menu-options', compact('tags'));
        }
    }
    ...
    public function registerDashboardWidgets($widgets, $widgetSettings)
    {
        ...
        return (new DashboardWidgetInstance)
            ...
            ->setTitle(trans('modules.plugins.blog::posts.widget_posts_recent'))
            ->setIcon('fas fa-edit')
            ->setColor('#f3c200')
            ...
            switch ($slug->reference_type) {
                case Post::class:
                    ...
                    if (!empty($post)) {
                        ...
                        if (function_exists('admin_bar')) {
                            admin_bar()->registerLink(trans('modules.plugins.blog::posts.edit_this_post'), route('posts.edit', $post->id));
                        }
                        ...
                        $data = [
                            'view'         => 'post',
                            'default_view' => 'modules.plugins.blog::themes.post',
                            'data'         => compact('post'),
                            'slug'         => $post->slug,
                        ];
                    }
                ...
                case Category::class:
                    ...
                    if (!empty($category)) {
                        ...
                        if (function_exists('admin_bar')) {
                            admin_bar()->registerLink(trans('modules.plugins.blog::categories.edit_this_category'),
                        ...
                        return [
                            'view'         => 'category',
                            'default_view' => 'modules.plugins.blog::themes.category',
    ...
    public function renderBlogPosts($shortcode)
    {
        ...
        $view = 'modules.plugins.blog::themes.templates.posts';
    ...
    public function renderBlogPage(?string $content, Page $page)
    {
        if ($page->id == setting('blog_page_id')) {
            $view = 'modules.plugins.blog::themes.loop';
    ...
    public function addSettings($data = null)
    {
        ...
        return $data . view('modules.plugins.blog::settings', compact('pages'))->render();
    }
    ...
    {
        if ($page->id == setting('blog_page_id')) {
            $subTitle = Html::tag('span', trans('modules.plugins.blog::base.blog_page'), ['class' => 'additional-page-name'])
                ->toHtml();

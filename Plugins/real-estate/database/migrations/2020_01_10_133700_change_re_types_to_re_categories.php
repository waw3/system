...
class ChangeReTypesToReCategories extends Migration
{
    ...
    public function up()
    {
        ...
        if (Schema::hasTable('language_meta')) {
            DB::table('language_meta')->where('reference_type', 'Modules\Plugins\RealEstate\Models\Type')
    ...
    public function down()
    {
        ...
        if (Schema::hasTable('language_meta')) {
            DB::table('language_meta')->where('reference_type', 'Modules\Plugins\RealEstate\Models\Category')
                ->update(['reference_type' => 'Modules\Plugins\RealEstate\Models\Type']);
        }
    }
}

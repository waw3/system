...
class PropertyForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('name', 'text', [
                'label'      => trans('modules.plugins.real-estate::property.form.name'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'placeholder'  => trans('modules.plugins.real-estate::property.form.name'),
                    'data-counter' => 120,
                ],
            ])
            ->add('type', 'customSelect', [
                'label'      => trans('modules.plugins.real-estate::property.form.type'),
                'label_attr' => ['class' => 'control-label required'],
            ...
            ->add('city_id', 'customSelect', [
                'label'      => trans('modules.plugins.real-estate::property.form.city'),
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
            ...
            ->add('location', 'location', [
                'label'      => trans('modules.plugins.real-estate::property.form.location'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'placeholder'  => trans('modules.plugins.real-estate::property.form.location'),
                    'data-counter' => 300,
                ],
            ])
            ->add('rowOpen1', 'html', [
            ...
            ->add('number_bedroom', 'number', [
                'label'      => trans('modules.plugins.real-estate::property.form.number_bedroom'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group col-md-3',
                ],
                'attr'       => [
                    'placeholder' => trans('modules.plugins.real-estate::property.form.number_bedroom'),
                ],
            ])
            ->add('number_bathroom', 'number', [
                'label'      => trans('modules.plugins.real-estate::property.form.number_bathroom'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group col-md-3',
                ],
                'attr'       => [
                    'placeholder' => trans('modules.plugins.real-estate::property.form.number_bathroom'),
                ],
            ])
            ->add('number_floor', 'number', [
                'label'      => trans('modules.plugins.real-estate::property.form.number_floor'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group col-md-3',
                ],
                'attr'       => [
                    'placeholder' => trans('modules.plugins.real-estate::property.form.number_floor'),
                ],
            ])
            ->add('square', 'number', [
                'label'      => trans('modules.plugins.real-estate::property.form.square'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group col-md-3',
                ],
                'attr'       => [
                    'placeholder' => trans('modules.plugins.real-estate::property.form.square'),
                ],
            ])
            ->add('rowClose1', 'html', [
                'html' => '</div>',
            ...
            ->add('price', 'text', [
                'label'      => trans('modules.plugins.real-estate::property.form.price'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                ...
                'attr'       => [
                    'id'          => 'price-number',
                    'placeholder' => trans('modules.plugins.real-estate::property.form.price'),
            ...
            ->add('period', 'customSelect', [
                'label'      => trans('modules.plugins.real-estate::property.form.period'),
                'label_attr' => ['class' => 'control-label required'],
                'wrapper'    => [
            ...
            ->addMetaBoxes([
                'image'    => [
                    'title'    => trans('modules.plugins.real-estate::property.form.images'),
            ...
            ->add('moderation_status', 'customSelect', [
                'label' => trans('modules.plugins.real-estate::property.moderation_status'),
                'label_attr' => ['class' => 'control-label required'],
                'attr' => [
                    'class' => 'form-control select-full',
                ],
            ...
            ->add('category_id', 'customSelect', [
                'label'      => trans('modules.plugins.real-estate::property.form.category'),
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class' => 'form-control select-search-full',
                ],
            ...
            ->add('project_id', 'customSelect', [
                'label'      => trans('modules.plugins.real-estate::property.form.project'),
                'label_attr' => ['class' => 'control-label'],

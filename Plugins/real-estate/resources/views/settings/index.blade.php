    ...
    <div class="max-width-1200">
        ...
        <div class="flexbox-annotated-section">
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('modules.plugins.real-estate::currency.currencies') }}</h2>
                </div>
                <div class="annotated-section-description pd-all-20 p-none-t">
                    <p class="color-note">{{ trans('modules.plugins.real-estate::currency.setting_description') }}</p>
                </div>
            </div>
                    ...
                    <div class="swatches-container">
                        <div class="header clearfix">
                            <div class="swatch-item">
                                {{ trans('modules.plugins.real-estate::currency.name') }}
                            </div>
                            <div class="swatch-item">
                                {{ trans('modules.plugins.real-estate::currency.symbol') }}
                            </div>
                            <div class="swatch-item swatch-decimals">
                                {{ trans('modules.plugins.real-estate::currency.number_of_decimals') }}
                            </div>
                            <div class="swatch-item swatch-exchange-rate">
                                {{ trans('modules.plugins.real-estate::currency.exchange_rate') }}
                            </div>
                            <div class="swatch-item swatch-is-prefix-symbol">
                                {{ trans('modules.plugins.real-estate::currency.is_prefix_symbol') }}
                            </div>
                            <div class="swatch-is-default">
                                {{ trans('modules.plugins.real-estate::currency.is_default') }}
                            </div>
                            <div class="remove-item">{{ trans('modules.plugins.real-estate::currency.remove') }}</div>
                        </div>
                        <ul class="swatches-list">

                        </ul>
                        <a href="#" class="js-add-new-attribute">
                            {{ trans('modules.plugins.real-estate::currency.new_currency') }}
                        </a>
                    </div>
                </div>
            </div>
        ...
        @if (!app()->environment('demo'))
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>{{ trans('modules.plugins.real-estate::real-estate.google_map') }}</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">{{ trans('modules.plugins.real-estate::real-estate.google_map_description') }}</p>
                    </div>
                </div>
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label class="text-title-field" for="google_map_api_key">{{ trans('modules.plugins.real-estate::real-estate.api_key') }}</label>
        ...
        <div class="flexbox-annotated-section" style="border: none">
            ...
            <div class="flexbox-annotated-section-content">
                <button class="btn btn-info" type="submit">{{ trans('modules.plugins.real-estate::currency.save_settings') }}</button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}
            ...
            <div class="swatch-item swatch-is-prefix-symbol" data-type="is_prefix_symbol">
                <div class="ui-select-wrapper">
                    <select class="ui-select">
                        <option value="1" __isPrefixSymbolChecked__>{{ trans('modules.plugins.real-estate::currency.before_number') }}</option>
                        <option value="0" __notIsPrefixSymbolChecked__>{{ trans('modules.plugins.real-estate::currency.after_number') }}</option>
                    </select>

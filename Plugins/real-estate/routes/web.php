...
Route::group(['namespace' => 'Modules\Plugins\RealEstate\Http\Controllers', 'middleware' => 'web'], function () {

    Route::group(['prefix' => mconfig('base.config.admin_dir') . '/real-estate', 'middleware' => 'auth'], function () {

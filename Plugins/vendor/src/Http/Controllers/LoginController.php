...
use Modules\Acl\Traits\LogoutGuardTrait;
...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        SeoHelper::setTitle(trans('modules.plugins.vendor::vendor.login'));
        return view('modules.plugins.vendor::auth.login');
    }
    ...
    protected function attemptLogin(Request $request)
    {
        if ($this->guard()->validate($this->credentials($request))) {
            ...
            if (config('modules.plugins.vendor.general.verify_email') && empty($vendor->confirmed_at)) {
                throw ValidationException::withMessages([
                    'confirmation' => [
                        trans('modules.plugins.vendor::vendor.not_confirmed', [

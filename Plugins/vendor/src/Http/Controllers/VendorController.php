...
use Modules\Plugins\Vendor\Forms\VendorForm;
use Modules\Plugins\Vendor\Http\Resources\VendorResource;
use Modules\Plugins\Vendor\Tables\VendorTable;
use Modules\Plugins\Vendor\Http\Requests\VendorCreateRequest;
use Modules\Plugins\Vendor\Http\Requests\VendorEditRequest;
...
class VendorController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.vendor::vendor.name'));
    ...
    {
        page_title()->setTitle(trans('modules.plugins.vendor::vendor.create'));
    ...
    public function edit($id, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('modules.plugins.vendor::vendor.edit'));

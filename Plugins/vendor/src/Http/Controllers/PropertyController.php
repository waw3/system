...
use Modules\Plugins\Vendor\Forms\PropertyForm;
...
use Modules\Plugins\Vendor\Tables\PropertyTable;
use Exception;
...
class PropertyController extends Controller
{
    ...
    public function index(PropertyTable $propertyTable)
    {
        ...
        return $propertyTable->render('modules.plugins.vendor::table.base');
    }
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        SeoHelper::setTitle(trans('modules.plugins.real-estate::property.edit') . ' "' . $property->name . '"');

...
namespace Modules\Plugins\Vendor\Http\Controllers\API;

use App\Http\Controllers\Controller;
use Modules\Base\Http\Responses\BaseHttpResponse;
use Modules\Plugins\Vendor\Http\Requests\LoginRequest;
use Modules\Plugins\Vendor\Http\Requests\RegisterRequest;
use Modules\Plugins\Vendor\Notifications\API\ConfirmEmailNotification;

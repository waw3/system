...
use Modules\Plugins\Vendor\Http\Requests\API\ResendEmailVerificationRequest;
use Modules\Plugins\Vendor\Http\Requests\API\VerifyEmailRequest;
use Modules\Plugins\Vendor\Notifications\ConfirmEmailNotification;

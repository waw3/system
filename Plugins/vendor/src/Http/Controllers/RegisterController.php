...
use Modules\Acl\Traits\RegistersUsers;
...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view('modules.plugins.vendor::auth.register');
    }
    ...
    public function confirm($email, Request $request, BaseHttpResponse $response, VendorInterface $vendorRepository)
    {
        ...
        return $response
            ...
            ->setMessage(trans('modules.plugins.vendor::vendor.confirmation_successful'));
    }
    ...
    public function resendConfirmation(Request $request, VendorInterface $vendorRepository, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setMessage(trans('modules.plugins.vendor::vendor.confirmation_resent'));
    }
    ...
    {
        // Notify the user
        $notificationConfig = config('modules.plugins.vendor.general.notification');
    ...
    public function register(Request $request, BaseHttpResponse $response)
    {
        ...
        if (config('modules.plugins.vendor.general.verify_email', true)) {
            $this->sendConfirmationToUser($vendor);
            return $this->registered($request, $vendor)
                ?: $response->setNextUrl($this->redirectPath())->setMessage(trans('modules.plugins.vendor::vendor.confirmation_info'));
        }
    ...
    {
        return view('modules.plugins.vendor::auth.verify');
    }
}

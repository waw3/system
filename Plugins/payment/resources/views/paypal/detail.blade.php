<p>{{ trans('modules.plugins.payment::payment.payment_id') }}: {{ $payment->id }}</p>

<div>
    {{ trans('modules.plugins.payment::payment.details') }}:
    <strong>
...
<p>{{ trans('modules.plugins.payment::payment.payer_name') }}
    : {{ $payment->payer->payer_info->first_name }} {{ $payment->payer->payer_info->last_name }}</p>
<p>{{ trans('modules.plugins.payment::payment.email') }}: {{ $payment->payer->payer_info->email }}</p>
<p>{{ trans('modules.plugins.payment::payment.phone')  }}: {{ $payment->payer->payer_info->phone }}</p>
<p>{{ trans('modules.plugins.payment::payment.country') }}: {{ $payment->payer->payer_info->country_code }}</p>

<p>
    {{ trans('modules.plugins.payment::payment.shipping_address') }}

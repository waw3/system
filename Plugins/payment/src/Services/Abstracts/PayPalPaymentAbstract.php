...
abstract class PayPalPaymentAbstract implements ProduceServiceInterface
{
    ...
    public function __construct()
    {
        ...
        config([
            'modules.plugins.payment.payment.paypal.client_id'     => setting('payment_paypal_client_id'),
            'modules.plugins.payment.payment.paypal.secret'        => setting('payment_paypal_client_secret'),
            'modules.plugins.payment.payment.paypal.settings.mode' => $payPalMode,
        ]);

        $config = config('modules.plugins.payment.payment.paypal');
        ...
        $this->paymentCurrency = config('modules.plugins.payment.payment.currency');

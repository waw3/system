...
namespace Modules\Plugins\Translation\Http\Controllers;

use Assets;
use Modules\Base\Http\Controllers\BaseController;
use Modules\Plugins\Translation\Manager;
use Illuminate\Http\Request;
use Modules\Plugins\Translation\Models\Translation;
...
class TranslationController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.translation::translation.menu_name'));
        ...
        $groups = ['' => trans('modules.plugins.translation::translation.choose_a_group')] + $groups;
        ...
        return view('modules.plugins.translation::index')

...
use Modules\Plugins\Contact\Forms\ContactForm;
use Modules\Plugins\Contact\Http\Requests\ContactReplyRequest;
...
use Modules\Plugins\Contact\Tables\ContactTable;
...
class ContactController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.plugins.contact::contact.menu'));
    ...
    {
        page_title()->setTitle(trans('modules.plugins.contact::contact.edit'));

...
class HookServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (function_exists('add_shortcode')) {
            ...
            shortcode()
                ->setAdminConfig('contact-form', view('modules.plugins.contact::partials.short-code-admin-config')->render());
        }
    }
    ...
    public function registerTopHeaderNotification($options)
    {
        if (Auth::user()->hasPermission('contacts.edit')) {
            ...
            return $options . view('modules.plugins.contact::partials.notification', compact('contacts'))->render();
        }
        return null;
    }
    ...
    {
        $view = 'modules.plugins.contact::forms.contact';
    ...
    {
        return $data . view('modules.plugins.contact::setting')->render();
    }
}

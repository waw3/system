<div class="flexbox-annotated-section">
    ...
    <div class="flexbox-annotated-section-annotation">
        <div class="annotated-section-title pd-all-20">
            <h2>{{ trans('modules.plugins.contact::contact.settings.email.title') }}</h2>
        </div>
        <div class="annotated-section-description pd-all-20 p-none-t">
            <p class="color-note">{{ trans('modules.plugins.contact::contact.settings.email.description') }}</p>
        </div>
    </div>
        ...
        <div class="wrapper-content pd-all-20">
                <div class="table-wrap">
                    <table class="table product-list ws-nm">
                        ...
                        <tbody>
                        @php
                            $email_templates = config('modules.plugins.contact.email.templates');
                        @endphp

...
use Modules\Plugins\Member\Http\Requests\API\ResendEmailVerificationRequest;
use Modules\Plugins\Member\Http\Requests\API\VerifyEmailRequest;
use Modules\Plugins\Member\Notifications\ConfirmEmailNotification;

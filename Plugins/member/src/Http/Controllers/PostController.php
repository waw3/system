...
use Modules\Plugins\Member\Forms\PostForm;
...
use Modules\Plugins\Member\Tables\PostTable;
use Exception;
...
class PostController extends Controller
{
    ...
    public function index(PostTable $postTable)
    {
        ...
        return $postTable->render('modules.plugins.member::table.base');
    }
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        SeoHelper::setTitle(trans('modules.plugins.blog::posts.edit') . ' "' . $post->name . '"');

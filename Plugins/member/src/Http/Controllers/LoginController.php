...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        SeoHelper::setTitle(trans('modules.plugins.member::member.login'));
        return view('modules.plugins.member::auth.login');
    }
    ...
    protected function attemptLogin(Request $request)
    {
        if ($this->guard()->validate($this->credentials($request))) {
            ...
            if (config('modules.plugins.member.general.verify_email') && empty($member->confirmed_at)) {
                throw ValidationException::withMessages([
                    'confirmation' => [
                        trans('modules.plugins.member::member.not_confirmed', [

        ...
        <table class="table table-striped custom-table m-b-0 table-stats table-log-viewer">
            <thead>
                <tr>
                    ...
                    @endforeach
                    <th class="text-center" width="120">{{ trans('modules.plugins.log-viewer::log-viewer.actions') }}</th>
                </tr>
            </thead>
            <tbody>
                @if (count($rows) > 0)
                    ...
                    @else
                        <tr>
                            <td colspan="11" class="text-center">{{ trans('modules.plugins.log-viewer::log-viewer.no_error') }}</td>
                        </tr>
                    @endif
            </tbody>
        </table>
            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.destroy') }}" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body with-padding">
                        <p>{!! trans('modules.plugins.log-viewer::log-viewer.confirm_delete_msg', ['date' => null]) !!}</p>
                    </div>

...
use Modules\Plugins\LogViewer\Contracts\Utilities\LogMenu as LogMenuContract;
use Modules\Plugins\LogViewer\Contracts\Utilities\LogStyler as LogStylerContract;
...
class LogMenu implements LogMenuContract
{
    ...
    {
        return $this->config->get('modules.plugins.log-viewer.general.' . $key, $default);
    }
}

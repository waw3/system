...
namespace Modules\Plugins\LogViewer\Bases;

use Modules\Plugins\LogViewer\Contracts\Utilities\LogLevels as LogLevelsContract;
use Modules\Plugins\LogViewer\Contracts\Table as TableContract;
...
abstract class Table implements TableContract
{
    ...
    public function __construct(array $data, LogLevelsContract $levels, $locale = null)
    {
        ...
        $this->setLocale(empty($locale) ? config('modules.plugins.log-viewer.general.locale') : $locale);
        $this->setData($data);
        $this->init();
    }
    ...
    {
        return trans('modules.plugins.log-viewer::' . $key, [], $this->locale);
    }

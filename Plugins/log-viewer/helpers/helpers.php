...
if (!function_exists('log_viewer')) {
     ...
     *
     * @return \Modules\Plugins\LogViewer\Contracts\LogViewer
     */
    function log_viewer()
    {
...
if (!function_exists('log_levels')) {
     ...
     *
     * @return \Modules\Plugins\LogViewer\Contracts\Utilities\LogLevels
     */
    function log_levels()
    {
...
if (!function_exists('log_menu')) {
     ...
     *
     * @return \Modules\Plugins\LogViewer\Contracts\Utilities\LogMenu
     */
    function log_menu()
    {
...
if (!function_exists('log_styler')) {
     ...
     *
     * @return \Modules\Plugins\LogViewer\Contracts\Utilities\LogStyler
     */
    function log_styler()
    {

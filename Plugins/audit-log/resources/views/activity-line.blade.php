...
<span>
    ...
    @endif
    @if (Lang::has('modules.plugins.audit-log::history.' . $history->action)) {{ trans('modules.plugins.audit-log::history.' . $history->action) }} @else {{ $history->action }} @endif
    @if ($history->module)
        @if (Lang::has('modules.plugins.audit-log::history.' . $history->module)) {{ trans('modules.plugins.audit-log::history.' . $history->module) }} @else {{ $history->module }} @endif
    @endif

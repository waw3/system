...
use Modules\Mailbox\Http\Controllers\InboxController;


Route::domain(mconfig('mailbox.config.domain', null))
    ->prefix(mconfig('mailbox.config.inbox_path'))
    ->middleware(mconfig('mailbox.config.middleware', 'web'))
    ->group(function () {

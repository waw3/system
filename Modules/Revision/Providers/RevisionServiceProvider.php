<?php namespace Modules\Revision\Providers;
...
class RevisionServiceProvider extends ServiceProvider
{
    ...
    protected $composerViews = [
       //'backend.includes.sidebar' => \Modules\Revision\Http\Composers\Backend\Composer::class
    ];
     ...
     */
    protected $commands = [
        //\Modules\Revision\Console\Commands\COMMAND_NAME::class => 'command.name:sun'
    ];

...
class HookServiceProvider extends ServiceProvider
{
            ...
            ->setSection([
                ...
                'fields'     => [
                    [
                        'id'         => 'site_title',
                        'type'       => 'text',
                        'label'      => trans('modules.setting::setting.general.site_title'),
                        'attributes' => [
                            'name'    => 'site_title',
                            'value'   => null,
                            'options' => [
                                'class'        => 'form-control',
                                'placeholder'  => trans('modules.setting::setting.general.site_title'),
                                'data-counter' => 255,
                            ],
                        ],
                    ],
                    [
                        ...
                        'type'       => 'select',
                        'label'      => trans('modules.setting::setting.general.show_site_name'),
                        'attributes' => [
                            'name'    => 'show_site_name',
                            'list'    => [
                                '0' => 'No',
                    ...
                    [
                        'id'         => 'seo_title',
                        'type'       => 'text',
                        'label'      => trans('modules.setting::setting.general.seo_title'),
                        'attributes' => [
                            'name'    => 'seo_title',
                            'value'   => null,
                            'options' => [
                                'class'        => 'form-control',
                                'placeholder'  => trans('modules.setting::setting.general.seo_title'),
                                'data-counter' => 120,
                            ],
                        ],
                    ],
                    [
                        'id'         => 'seo_description',
                        'type'       => 'textarea',
                        'label'      => trans('modules.setting::setting.general.seo_description'),
                        'attributes' => [
    ...
    public function addStatsWidgets($widgets, $widgetSettings)
    {
        ...
        return (new DashboardWidgetInstance)
            ...
            ->setTitle(trans('modules.theme::theme.theme'))
    ...
    {
        return $data . view('modules.theme::setting')->render();
    }
}

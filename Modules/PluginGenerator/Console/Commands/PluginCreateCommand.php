...
namespace Modules\PluginGenerator\Console\Commands;
...
class PluginCreateCommand extends BaseMakeCommand
{
    ...
    public function handle()
    {
        ...
        File::copy(__DIR__ . '/../../Resources/stubs/plugin.json', $location . '/plugin.json');
        File::copy(__DIR__ . '/../../Resources/stubs/Plugin.stub', $location . '/src/Plugin.php');
    ...
    {
        return __DIR__ . '/../../../DevTool/Resources/stubs/module';
    }

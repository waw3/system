...
class Menu
{
    ...
    public function generateMenu($args = [])
    {
        ...
        if (!$this->cache->has($cacheKey) || mconfig('menu.general.cache.enabled') == false) {
        ...
        return view('modules.menu::partials.default', $data)->render();
    }
    ...
    public function generateSelect($args = [])
    {
        ...
        return view('modules.menu::partials.select', $data)->render();
    }
    ...
    {
        return config('modules.menu.config.locations', []);
    }
    ...
    public function addMenuLocation(string $location, string $description): self
    {
        ...
        config()->set('modules.menu.config.locations', $locations);

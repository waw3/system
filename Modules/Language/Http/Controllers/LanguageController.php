...
class LanguageController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.language::language.name'));
        ...
        return view('modules.language::index', compact('languages', 'flags', 'activeLanguages'));
    }
    ...
    public function postStore(LanguageRequest $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response
                ->setData(view('modules.language::partials.language-item', ['item' => $language])->render())
    ...
    /**
     * @param string $code
     * @param \Modules\Language\Services\LanguageManager $language

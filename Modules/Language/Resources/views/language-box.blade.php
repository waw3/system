...
@if (count($languages) > 1)
    <div><strong>{{ trans('modules.language::language.translations') }}</strong>
    ...
    {!! Form::modalAction('confirm-change-language-modal', trans('modules.language::language.confirm-change-language'), 'warning', trans('modules.language::language.confirm-change-language-message'), 'confirm-change-language-button', trans('modules.language::language.confirm-change-language-btn')) !!}
@endif

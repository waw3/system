...
class Model
{
    ...
    {
        $this->useCache = mconfig('sitemap.config.use_cache', $this->useCache);
        $this->cacheKey = mconfig('sitemap.config.cache_key', $this->cacheKey);
        $this->cacheDuration = mconfig('sitemap.config.cache_duration', $this->cacheDuration);
        $this->escaping = mconfig('sitemap.config.escaping', $this->escaping);
        $this->useLimitSize = mconfig('sitemap.config.use_limit_size', $this->useLimitSize);
        $this->useStyles = mconfig('sitemap.config.use_styles', $this->useStyles);
        $this->sloc = mconfig('sitemap.config.styles_location', $this->sloc);
        $this->maxSize = mconfig('sitemap.config.max_size', $this->maxSize);
        $this->useGzip = mconfig('sitemap.config.use_gzip', $this->useGzip);
    }

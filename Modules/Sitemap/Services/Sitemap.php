...
class Sitemap
{
     ...
     * @access public
     * @param mixed $loc
     * @param mixed $lastmod (default: null)
     * @param mixed $priority (default: null)
     * @param mixed $freq (default: null)
     * @param mixed $images (default: [])
     * @param mixed $title (default: null)
     * @param mixed $translations (default: [])
     * @param mixed $videos (default: [])
     * @param mixed $googlenews (default: [])
     * @param mixed $alternates (default: [])
     * @return void
     */
    ...
    public function generate($format = 'xml', $style = null)
    {
        ...
        if ($this->isCached()) {
            ...
            ('sitemapindex' == $format) ? Cache::put($this->model->getCacheKey(), $this->model->getSitemaps(),
                $this->model->getCacheDuration()) : Cache::put($this->model->getCacheKey(),
                $this->model->getItems(), $this->model->getCacheDuration());
        }

        if (!$this->model->getLink()) {
            $this->model->setLink(config('app.url'));
        }
        ...
        return [
            'content' => view()->make('modules.sitemap::xml', ['items' => $this->model->getItems(), 'style' => $style])->render(),

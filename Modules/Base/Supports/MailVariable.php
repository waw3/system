...
class MailVariable
{
    ...
    public function initVariableValues()
    {
        $this->variableValues['core'] = [
            'header'           => get_setting_email_template_content('Modules', 'Base', 'header'),
            'footer'           => get_setting_email_template_content('Modules', 'Base', 'footer'),
            'site_title'       => setting('admin_title'),
            'site_url'         => url(''),
            'site_logo'        => setting('admin_logo') ? get_image_url(setting('admin_logo')) : url(mconfig('base.config.logo')),

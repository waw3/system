...
abstract class FormAbstract extends Form
{
     ...
     * @var string
     */
    protected $template = 'modules.base::forms.form';
    ...
    public function getMetaBox($name): string
    {
        ...
        return view('modules.base::forms.partials.meta-box', compact('metaBox'))->render();
    }
    ...
    public function getActionButtons(): string
    {
        if ($this->actionButtons === '') {
            return view('modules.base::elements.form-actions')->render();
        }
    ...
    {
        $this->setFormOption('template', 'modules.base::forms.form-tabs');
        return $this;
    }

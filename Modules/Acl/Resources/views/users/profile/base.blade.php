                        ...
                        <div class="modal-content">
                            <form class="avatar-form" method="post" action="{{ route('users.profile.image', $user->id) }}" enctype="multipart/form-data">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="avatar-modal-label"><i class="til_img"></i><strong>{{ trans('modules.acl::users.change_profile_image') }}</strong></h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="avatar-body">
                                        ...
                                        <div class="avatar-upload">
                                            ...
                                            {!! Form::token() !!}
                                            <label for="avatarInput">{{ trans('modules.acl::users.new_image') }}</label>
                                            <input class="avatar-input" id="avatarInput" name="avatar_file" type="file">
                                        </div>

                                        <div class="loading" tabindex="-1" role="img" aria-label="{{ trans('modules.acl::users.loading') }}"></div>
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">{{ trans('modules.acl::users.close') }}</button>
                                    <button class="btn btn-primary avatar-save" type="submit">{{ trans('modules.acl::users.save') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="profile-content">
                <div class="tabbable-custom">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a href="#tab_1_1" class="nav-link active" data-toggle="tab" aria-expanded="true">{{ trans('modules.acl::users.info.title') }}</a>
                        </li>
                        @if ($canChangeProfile)
                            <li class="nav-item">

...
<a href="#" class="btn btn-icon btn-danger deleteDialog" data-toggle="tooltip" data-section="{{ route('users.destroy', $item->id) }}" role="button" data-original-title="{{ trans('modules.base::tables.delete_entry') }}" >

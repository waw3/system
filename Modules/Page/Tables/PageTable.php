...
class PageTable extends TableAbstract
{
        ...
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                ...
                if (setting('show_on_front') == $item->id) {
                    $name .= Html::tag('span', ' — ' . trans('modules.page::pages.front_page'), [
    ...
    public function columns()
    {
        return [
            ...
            'template'   => [
                'name'  => 'pages.template',
                'title' => trans('modules.base::tables.template'),
            ],
            'created_at' => [
    ...
    public function buttons()
    {
        ...
        return apply_filters('base_filter_datatables_buttons', $buttons, Page::class);
    }

...
use Modules\Blog\Tables\TagTable;
...
class TagController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.blog::tags.menu'));
    ...
    {
        page_title()->setTitle(trans('modules.blog::tags.create'));
    ...
    public function edit($id, Request $request, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('modules.blog::tags.edit') . ' "' . $tag->name . '"');
    ...
    public function destroy($id, Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response->setMessage(trans('modules.blog::tags.deleted'));
        } catch (Exception $exception) {
            return $response
                ->setError()
                ->setMessage(trans('modules.blog::tags.cannot_delete'));
        }
    }

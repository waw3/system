...
class PostController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.blog::posts.menu_name'));
    ...
    {
        page_title()->setTitle(trans('modules.blog::posts.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('modules.blog::posts.edit') . ' "' . $post->name . '"');
    ...
    public function getWidgetRecentPosts(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setData(view('modules.blog::posts.widgets.posts', compact('posts', 'limit'))->render());
    }
}

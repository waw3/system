...
namespace Modules\CustomField\Tables;

use Modules\CustomField\Models\FieldGroup;
...
class CustomFieldTable extends TableAbstract
{
     ...
     * @var string
     */
    protected $view = 'modules.custom-field::list';
                ...
                return table_actions('custom-fields.edit', 'custom-fields.destroy', $item,
                    Html::link(
                        ...
                        [
                            ...
                            'title' => trans('modules.custom-field::base.export'),
                        ],
                        null,
                        false
                    )->toHtml());
    ...
    public function buttons()
    {
        ...
        $buttons['import-field-group'] = [
            'link' => '#',
            'text' => view('modules.custom-field::_partials.import')->render(),
        ];

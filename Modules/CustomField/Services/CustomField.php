...
use Throwable, Closure, Exception, Eloquent;
use Illuminate\Contracts\Container\BindingResolutionException;
use Illuminate\Foundation\Application;
use Illuminate\Http\Request;
use Illuminate\Support\Str;
use Modules\Base\Enums\BaseStatusEnum;
use Modules\CustomField\Repositories\Interfaces\{FieldGroupInterface, FieldItemInterface, CustomFieldInterface};
...
class CustomField
{
    ...
    {
        return view('modules.custom-field::_script-templates.rules', [
    ...
    {
        return view('modules.custom-field::custom-fields-boxes-renderer', [
    ...
    public function renderAssets()
    {
        if (!$this->isRenderedAssets) {
            echo view('modules.custom-field::_script-templates.render-custom-fields')->render();
    ...
    public function registerModule($module): self
    {
        ...
        $configKey = 'modules.custom-field.config.supported';
    ...
    {
        return mconfig('custom-field.config.supported', []);
    }
}

<div class="custom-fields-rules">
    ...
    @include('modules.custom-field::_script-templates.edit-field-group-items')
    <textarea name="rules"
    ...
    <label class="control-label mb15">
        <b>{{ trans('modules.custom-field::base.form.rules.rules_helper') }}</b>
    </label>
    <div class="line-group-container"></div>
    <div class="line">
        <p class="mt20"><b>{{ trans('modules.custom-field::base.form.rules.or') }}</b></p>
        <a class="location-add-rule-or location-add-rule btn btn-info" href="#">
            {{ trans('modules.custom-field::base.form.rules.add_rule_group') }}
        </a>
    </div>
</div>

...
class CustomFieldForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        if ($this->getModel()) {
            ...
            $this->setActionButtons(view('modules.custom-field::actions', ['object' => $this->getModel()])->render());
        }
        $this
            ...
            ->addMetaBoxes([
                'rules'            => [
                    'title'   => trans('modules.custom-field::base.form.rules.rules'),
                    'content' => view('modules.custom-field::rules', [
                ...
                'field-items-list' => [
                    'title'   => trans('modules.custom-field::base.form.field_items_information'),
                    'content' => view('modules.custom-field::field-items-list')->render(),
                ],
            ]);
    }
}

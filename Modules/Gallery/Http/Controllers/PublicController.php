...
use Modules\Gallery\Models\Gallery as GalleryModel;
...
class PublicController extends Controller
{
    ...
    public function getGalleries()
    {
        ...
        return Theme::scope('galleries', compact('galleries'), 'modules.gallery::themes.galleries')->render();
    }
    ...
    public function getGallery($slug)
    {
        ...
        return Theme::scope('gallery', compact('gallery'), 'modules.gallery::themes.gallery')->render();
    }
}

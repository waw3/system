...
class DashboardController extends BaseController
{
    ...
    public function getDashboard(Request $request)
    {
        ...
        $widgetData = apply_filters('admin_dashboard_list', [], $widgets);
        ksort($widgetData);
        ...
        return view('modules.dashboard::list', compact('widgets', 'userWidgets'));
    }
    ...
    public function postEditWidgetSettingItem(Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            if (!$widget) {
                return $response
                    ->setError()
                    ->setMessage(trans('modules.dashboard::dashboard.widget_not_exists'));
            }
    ...
    public function postUpdateWidgetOrder(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response->setMessage(trans('modules.dashboard::dashboard.update_position_success'));
    }
    ...
    public function getHideWidget(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response->setMessage(trans('modules.dashboard::dashboard.hide_success'));
    }
    ...
    public function postHideWidgets(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ...
            ->setMessage(trans('modules.dashboard::dashboard.hide_success'));
    }
}

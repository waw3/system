...
@section('content')
    ...
    <div class="widget-main" id="wrap-widgets">
        <div class="row">
            <div class="col-sm-6">
                <h2>{{ trans('modules.widget::global.available') }}</h2>
                <p>{{ trans('modules.widget::global.instruction') }}</p>
                <ul id="wrap-widget-1">
                                ...
                                <form method="post">
                                    ...
                                    <div class="widget-control-actions">
                                        <div class="float-left">
                                            <button class="btn btn-danger widget-control-delete">{{ trans('modules.widget::global.delete') }}</button>
                                        </div>
                                        <div class="float-right text-right">
                                            <button class="btn btn-primary widget_save">{{ trans('modules.base::forms.save') }}</button>
                                        </div>
                        ...
                        <div class="col-sm-6 sidebar-item" data-id="{{ $group->getId() }}">
                            <div class="sidebar-area">
                                ...
                                <ul id="wrap-widget-{{ $index }}">
                                    @include('modules.widget::item', compact('widget_areas'))
                                    <div class="clearfix"></div>
                                </ul>
                            </div>
                        </div>

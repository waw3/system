...
namespace Modules\JsValidation\Services;
...
use Modules\JsValidation\Javascript\JavascriptValidator;
use Modules\JsValidation\Javascript\MessageParser;
use Modules\JsValidation\Javascript\RuleParser;
use Modules\JsValidation\Javascript\ValidatorHandler;
use Modules\JsValidation\Support\DelegatedValidator;
use Modules\JsValidation\Support\ValidationRuleParserProxy;
...
class JsValidatorFactory
{
    ...
    protected function setOptions($options)
    {
        ...
        $options['view'] = empty($options['view']) ? 'modules.jsvalidation::bootstrap' : $options['view'];

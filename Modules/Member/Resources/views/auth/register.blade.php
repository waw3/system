        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card login-form">
                    <div class="card-body">
                        <h4 class="text-center">{{ trans('modules.member::dashboard.register-title') }}</h4>
                        <br>
                        <form method="POST" action="{{ route('public.member.register') }}">
                            ...
                            <div class="form-group">
                                <input id="first_name" type="text"
                                       ...
                                       placeholder="{{ trans('modules.member::dashboard.first_name') }}">
                            ...
                            <div class="form-group">
                                <input id="last_name" type="text"
                                       ...
                                       placeholder="{{ trans('modules.member::dashboard.last_name') }}">
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-blue btn-full fw6">
                                    {{ trans('modules.member::dashboard.register-cta') }}
                                </button>
                            </div>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest(\Modules\Member\Http\Requests\RegisterRequest::class); !!}
@endpush

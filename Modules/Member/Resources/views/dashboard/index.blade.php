            ...
            <div class="sidebar-profile">
              ...
              <div class="mb3">
                <div class="light-gray-text mb2">
                  <i class="fas fa-calendar-alt mr2"></i>{{ trans('modules.member::dashboard.joined_on', ['date' => $user->created_at->format('F d, Y')]) }}
                </div>
                @if ($user->dob)
                  <div class="light-gray-text mb2">
                    <i class="fas fa-child mr2"></i>{{ trans('modules.member::dashboard.dob', ['date' => $user->dob]) }}
                  </div>
                @endif
              </div>
            </div>
          ...
          <div class="col-md-9 mb-3">
            {!! apply_filters(MEMBER_TOP_STATISTIC_FILTER, null) !!}
              @if (is_plugin_active('blog'))
                  @include('modules.member::components.statistic')
              @endif

...
use Assets;
use Modules\Member\Http\Resources\ActivityLogResource;
...
use Modules\Member\Http\Requests\AvatarRequest;
use Modules\Member\Http\Requests\SettingRequest;
use Modules\Member\Http\Requests\UpdatePasswordRequest;
...
class PublicController extends Controller
{
    ...
    public function getDashboard()
    {
        ...
        return view('modules.member::dashboard.index', compact('user'));
    }
    ...
    public function getSettings()
    {
        ...
        return view('modules.member::settings.index', compact('user'));
    }
    ...
    public function getSecurity()
    {
        ...
        return view('modules.member::settings.security');
    }
    ...
    public function postSecurity(UpdatePasswordRequest $request, BaseHttpResponse $response)
    {
        if (!Hash::check($request->input('current_password'), auth()->guard('member')->user()->getAuthPassword())) {
            return $response
                ->setError()
                ->setMessage(trans('modules.member::dashboard.current_password_not_valid'));
        }
        ...
        return $response->setMessage(trans('modules.member::dashboard.password_update_success'));
    }
    ...
    public function postAvatar(
        ...
        try {
            ...
            return $response
                ->setMessage(trans('modules.member::dashboard.update_avatar_success'))

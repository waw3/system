...
use Modules\Member\Http\Requests\MemberEditRequest;
...
class MemberController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.member::member.menu_name'));
    ...
    {
        page_title()->setTitle(trans('modules.member::member.create'));
    ...
    public function edit($id, FormBuilder $formBuilder)
    {
        ...
        page_title()->setTitle(trans('modules.member::member.edit'));

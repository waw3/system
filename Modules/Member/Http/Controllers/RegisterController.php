...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view('modules.member::auth.register');
    }
    ...
    public function confirm($email, Request $request, BaseHttpResponse $response, MemberInterface $memberRepository)
    {
        ...
        return $response
            ...
            ->setMessage(trans('modules.member::member.confirmation_successful'));
    }
    ...
    public function resendConfirmation(Request $request, MemberInterface $memberRepository, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setMessage(trans('modules.member::member.confirmation_resent'));
    }
    ...
    {
        // Notify the user
        $notificationConfig = mconfig('member.config.notification');
    ...
    public function register(Request $request, BaseHttpResponse $response)
    {
        ...
        if (mconfig('member.config.verify_email', true)) {
            $this->sendConfirmationToUser($member);
            return $this->registered($request, $member)
                ?: $response->setNextUrl($this->redirectPath())->setMessage(trans('modules.member::member.confirmation_info'));
        }
    ...
    {
        return view('modules.member::auth.verify');
    }
}

...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        SeoHelper::setTitle(trans('modules.member::member.login'));
        return view('modules.member::auth.login');
    }
    ...
    protected function attemptLogin(Request $request)
    {
        if ($this->guard()->validate($this->credentials($request))) {
            ...
            if (mconfig('member.config.verify_email') && empty($member->confirmed_at)) {
                throw ValidationException::withMessages([
                    'confirmation' => [
                        trans('modules.member::member.not_confirmed', [

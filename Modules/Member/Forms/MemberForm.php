...
class MemberForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('email', 'text', [
                'label'      => trans('modules.member::member.form.email'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
            ...
            ->add('is_change_password', 'checkbox', [
                'label'      => trans('modules.member::member.form.change_password'),
            ...
            ->add('password', 'password', [
                'label'      => trans('modules.member::member.form.password'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'data-counter' => 60,
                ],
            ...
            ->add('password_confirmation', 'password', [
                'label'      => trans('modules.member::member.form.password_confirmation'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'data-counter' => 60,
                ],

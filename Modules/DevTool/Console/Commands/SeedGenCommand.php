<?php namespace Modules\DevTool\Console\Commands;

use DB, File, Schema;
use Illuminate\Console\Command;
use Symfony\Component\Console\Input\InputArgument;
use Symfony\Component\Console\Input\InputOption;
use Modules\DevTool\Exceptions\TableNotFoundException;

/**
 * SeedGenCommand class.
 *
 * @extends Command
 */
class SeedGenCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'cms:db:seed:create';
     ...
     *
     * @return \Modules\DevTool\Console\Commands
     */
    ...
    {
        // if clean option is checked empty SeedGen template in DatabaseSeeder.php
        if ($this->option('clean')) {
            app('seedgen')->cleanSection();
        }
    ...
    {
        return array(
            array('clean', null, InputOption::VALUE_NONE, 'clean seedgen section', null),
    ...
    protected function generateFileName($table)
    {
        ...
        $className = app('seedgen')->generateClassName($table);
        $seedPath = base_path() . mconfig('devtool.config.seed.path');

...
namespace Modules\DevTool\Console\Commands;
    ...
    public function handle($return = false)
    {
        ...
        if (empty($allRoles)) {
            ...
            foreach ($users as $user) {
                $user->permissions = [
                    'superuser'    => (boolean)$user->super_user,
                    'manage_supers' => (boolean)$user->manage_supers,
                ];
            ...
            foreach ($allRoles as $role) {
                ...
                foreach ($userRoles as $userRole) {
                    ...
                    if (!empty($user)) {
                        $user = $user[0];
                        $permissions['superuser'] = (boolean)$user->super_user;
                        $permissions['manage_supers'] = (boolean)$user->manage_supers;

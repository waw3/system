...
namespace Modules\DevTool\Console\Commands\GitCommitChecker;
...
class InstallPhpcs extends Command
{
    ...
    public function handle()
    {
        ...
        $phpcs =  modules_path('DevTool/phpcs.xml');
        $rootphpcs = base_path('phpcs.xml');

        // Checkout existence of sample phpcs.xml.
        if (!file_exists($phpcs)) {
            $this->error('The sample phpcs.xml does not exist! Create One!');

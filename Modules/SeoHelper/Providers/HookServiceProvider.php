...
class HookServiceProvider extends ServiceProvider
{
    ...
    {
        if (!empty($data) && in_array(get_class($data), mconfig('seohelper.config.supported', []))) {
            Assets::addScriptsDirectly('vendor/core/packages/seo-helper/js/seo-helper.js');
            add_meta_box('seo_wrap', trans('modules.seohelper::seo-helper.meta_box_header'), [$this, 'seoMetaBox'],
    ...
    public function seoMetaBox()
    {
        ...
        return view('modules.seohelper::meta_box', compact('meta', 'object'));
    }

...
use Modules\SeoHelper\Exceptions\InvalidArgumentException;
...
class Title implements TitleContract
{
    ...
    protected function init()
    {
        ...
        $this->setSeparator(mconfig('seohelper.config.title.separator', '-'));
        $this->switchPosition(mconfig('seohelper.config.title.first', true));
        $this->setMax(mconfig('seohelper.config.title.max', 55));
    }
     ...
     * @param  string $title
     *
     * @return \Modules\SeoHelper\Entities\Title
     */
     ...
     * @param  int $max
     *
     * @throws \Modules\SeoHelper\Exceptions\InvalidArgumentException
     */

...
use Modules\SeoHelper\Contracts\Entities\AnalyticsContract;
use Modules\SeoHelper\Contracts\Entities\DescriptionContract;
use Modules\SeoHelper\Contracts\Entities\MiscTagsContract;
use Modules\SeoHelper\Contracts\Entities\TitleContract;
use Modules\SeoHelper\Contracts\Entities\WebmastersContract;
...
class SeoMeta implements SeoMetaContract
{
    ...
    {
        $this->title(new \Modules\SeoHelper\Entities\Title);
        $this->description(new \Modules\SeoHelper\Entities\Description);
        $this->misc(new \Modules\SeoHelper\Entities\MiscTags);
        $this->webmasters(new \Modules\SeoHelper\Entities\Webmasters);
        $this->analytics(new \Modules\SeoHelper\Entities\Analytics);
    }

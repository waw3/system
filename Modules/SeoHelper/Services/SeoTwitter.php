...
use Modules\SeoHelper\Contracts\Entities\TwitterCardContract;
...
class SeoTwitter implements SeoTwitterContract
{
     ...
     *
     * @var \Modules\SeoHelper\Contracts\Entities\TwitterCardContract
     */
    protected $card;
    ...
    {
        $this->setCard(new \Modules\SeoHelper\Entities\Twitter\Card);
    }

    /**
     * Set the Twitter Card instance.
     *
     * @param  \Modules\SeoHelper\Contracts\Entities\TwitterCardContract $card
     *
     * @return \Modules\SeoHelper\SeoTwitter
     */

...
class SettingController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('modules.setting::setting.title'));
    ...
    {
        page_title()->setTitle(trans('modules.base::layouts.setting_email'));
        Assets::addScriptsDirectly('vendor/core/js/setting.js');

        return view('modules.setting::email');
    }
    ...
    public function getEditEmailTemplate($type, $name, $template)
    {
        ...
        return view('modules.setting::email-template-edit', compact('emailContent', 'emailSubject', 'pluginData'));
    }
    ...
    public function postResetToDefault(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response->setMessage(trans('modules.setting::setting.email.reset_success'));
    }
    ...
    public function postSendTestEmail(
        ...
        try {
            $emailHandler->send(
                file_get_contents(modules_path('Setting/Resources/email-templates/test.tpl')),
                __('Test title'),
                $request->input('email'),
                [],
                true
    ...
    {
        page_title()->setTitle(trans('modules.setting::setting.media.title'));

        return view('modules.setting::media');
    }
...
//         {"error":false,"data":{"activated_at":"Mar 31 2020","licensed_to":"KrackenLabs Technologies"},"message":"Verified! Thanks for purchasing."}
...
*/
        ...
        $data = [
            'activated_at' => 'Mar 31 2020',
            'licensed_to'  => 'KrackenLabs Technologies',
        ];

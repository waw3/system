        ...
        <div class="flexbox-annotated-section">
            ...
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('modules.setting::setting.media.title') }}</h2>
                </div>
                <div class="annotated-section-description pd-all-20 p-none-t">
                    <p class="color-note">{{ trans('modules.setting::setting.media.description') }}</p>
                </div>
            </div>
                ...
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        <label class="text-title-field"
                               for="media_driver">{{ trans('modules.setting::setting.media.driver') }}
                        </label>
                    ...
                    <div class="s3-config-wrapper" @if (config('filesystems.default') !== 's3') style="display: none;" @endif>
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_aws_access_key_id">{{ trans('modules.setting::setting.media.aws_access_key_id') }}</label>
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_aws_secret_key">{{ trans('modules.setting::setting.media.aws_secret_key') }}</label>
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_aws_default_region">{{ trans('modules.setting::setting.media.aws_default_region') }}</label>
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_aws_bucket">{{ trans('modules.setting::setting.media.aws_bucket') }}</label>
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_aws_url">{{ trans('modules.setting::setting.media.aws_url') }}</label>
